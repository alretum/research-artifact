...
public class ItemView {
    ...
    /**
     * One answer option, with its zero-based position in the item.
     *
    ...
    /**
     * The filter's judgement on one failure mode, flattened for rendering.
     *
    ...
    /**
     * Everything a detail view needs about one stored item.
     *
